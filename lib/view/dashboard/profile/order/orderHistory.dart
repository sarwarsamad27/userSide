...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
  ...
  void initState() {
    ...
    // ✅ Sirf tab fetch karo jab list empty ho (first time ya fresh open)
    // Back aane pe dobara hit nahi hoga
      ...
      body: CustomBgContainer(
        child: Consumer<GetMyOrderProvider>(
          builder: (context, provider, child) {
            ...
            // ✅ RefreshIndicator wrap kiya — sirf yahan se refresh hoga
            return RefreshIndicator(
              ...
              child: Padding(
                ...
                child: ListView.separated(
                  ...
                  // ✅ Pull-to-refresh kaam kare empty space pe bhi
